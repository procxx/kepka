...
//f_notify_notification_set_hint_int32_t notify_notification_set_hint_int32_t = nullptr;
//f_notify_notification_set_hint_uint32_t notify_notification_set_hint_uint32_t = nullptr;
...
//	load(lib_notify, "notify_notification_set_hint_int32_t", notify_notification_set_hint_int32_t);
//	load(lib_notify, "notify_notification_set_hint_uint32_t", notify_notification_set_hint_uint32_t);
