...
void AudioPlayerLoader::saveDecodedSamples(QByteArray *samples, qint64 *samplesCount) {
...
void AudioPlayerLoader::takeSavedDecodedSamples(QByteArray *samples, qint64 *samplesCount) {
