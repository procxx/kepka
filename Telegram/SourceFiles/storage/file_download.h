...
public:
	...
	virtual qint32 currentOffset(bool includeSkipped = false) const = 0;
	qint32 fullSize() const;
...
private:
	...
	qint32 _skippedBytes = 0;
	qint32 _nextRequestOffset = 0;

	MTP::DcId _dcId = 0; // for photo locations
	const StorageImageLocation *_location = nullptr;

	quint64 _id = 0; // for document locations
