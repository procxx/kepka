...
public:
	...
	void clear();
	qint32 itemTop(const FullMsgId &msgId) const;
...
private:
	...
	qint32 migratedIndexSkip() const;

	void fixItemIndex(qint32 &current, MsgId msgId) const;
	bool itemHasPoint(MsgId msgId, qint32 index, qint32 x, qint32 y) const;
	...
	void addSelectionRange(qint32 selFrom, qint32 selTo, History *history);
	...
	bool _selMode = false;
	TextSelection itemSelectedValue(qint32 index) const;
	...
	qint32 setLayoutItem(qint32 index, Overview::Layout::AbstractItem *item, qint32 top);

	object_ptr<Ui::FlatInput> _search;
	object_ptr<Ui::CrossButton> _cancelSearch;
	QVector<MsgId> _results;
	qint32 _itemsToBeLoaded;

	// photos
	qint32 _photosInRow = 1;
...
public:
	...
	qint32 lastWidth() const;
	qint32 lastScrollTop() const;
	qint32 countBestScroll() const;

	void fastShow(bool back = false, qint32 lastScrollTop = -1);
